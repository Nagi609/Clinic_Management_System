...
async function GET(request) {
    try {
        ...
        const contacts = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].contact.findMany({
            where: {
                userId
            },
            orderBy: {
...
async function POST(request) {
    try {
        ...
        const contact = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].contact.create({
            data: {
                name,
                phone,
                email,
...
async function PUT(request) {
    try {
        ...
        const contact = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].contact.findUnique({
            where: {
                id
            }
        });
        ...
        const updatedContact = await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].contact.update({
            where: {
                id
            },
            data: {
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$backend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].contact.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7dd46349._.js.map