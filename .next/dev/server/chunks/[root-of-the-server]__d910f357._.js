...
async function POST(request) {
    try {
        ...
        let user;
        try {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
                where: {
                    OR: [
                        {
        ...
        try {
            passwordMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$bcryptjs$40$2$2e$4$2e$3$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(String(password), user.password);
        } catch (bcryptError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d910f357._.js.map