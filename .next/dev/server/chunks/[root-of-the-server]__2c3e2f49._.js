...
async function GET(request) {
    try {
        ...
        const activities = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].activity.findMany({
            where: {
                userId
            },
            orderBy: {
...
async function POST(request) {
    try {
        ...
        const activity = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].activity.create({
            data: {
                type,
                message,
                userId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c3e2f49._.js.map